...
class AccountAdmin(admin.ModelAdmin):
    ...
    def balance_display(self, obj):
        ...
        return format_html('<strong>GH₵ {:,.2f}</strong>', obj.balance)
...
class TransactionAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'id', 'transaction_type', 'amount_display', 'from_account', 
        'to_account', 'status_display', 'timestamp'
    )
    ...
    def amount_display(self, obj):
        ...
        return format_html('GH₵ {:,.2f}', obj.amount)
...
class LoanAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'id', 'user', 'amount_display', 'interest_rate', 'term_months',
        'outstanding_display', 'status_display', 'created_at'
    )
    ...
    def outstanding_display(self, obj):
        return format_html('GH₵ {:,.2f}', obj.outstanding_balance)
