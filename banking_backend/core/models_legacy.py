...
class Transaction(models.Model):
    ...
    from_account = models.ForeignKey(
        Account, on_delete=models.CASCADE, related_name="outgoing_transactions", null=True, blank=True
    )
...
class CheckDeposit(models.Model):
    ...
    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name="check_deposits")
    amount = models.DecimalField(max_digits=12, decimal_places=2)
...
class Expense(models.Model):
    ...
    transaction = models.OneToOneField(
        Transaction, on_delete=models.SET_NULL, null=True, blank=True, related_name="expense"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
