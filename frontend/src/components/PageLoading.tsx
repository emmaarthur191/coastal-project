...
interface PageLoadingProps {
  /** Optional message to display while loading. Defaults to 'Loading page...'. */
  message?: string;
}

/**
 * A full-screen loading component with animated background orbs and a pulse animation.
 * Used during route transitions or initial application load.
 *
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-mauve-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative text-center animate-scale-in">
        ...
        <div className="flex justify-center gap-1 mt-4">
          ...
          <div className="w-1.5 h-1.5 bg-primary-500 rounded-full animate-pulse delay-200"></div>
          <div className="w-1.5 h-1.5 bg-primary-500 rounded-full animate-pulse delay-400"></div>
        </div>
      </div>
    </div>
  );
