...
const ProtectedStaffRoute: React.FC<ProtectedStaffRouteProps> = ({
  ...
  if (loading) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gray-50">
  ...
  if (!isAuthenticated || !user) {
    console.warn(
      'ProtectedStaffRoute: Auth failed or no user - network issue? Redirecting to login.'
    );
