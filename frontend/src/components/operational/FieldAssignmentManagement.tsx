...
const FieldAssignmentManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <GlassCard className="p-5 border-l-4 border-l-coastal-primary shadow-xl border border-slate-200/50 dark:border-slate-700/50">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            <h2 className="text-2xl font-black text-slate-900 dark:text-slate-100 tracking-tighter flex items-center gap-3">
              <MapPin className="w-6 h-6 text-coastal-primary" /> Field Operations Mapping
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
              Assign trusted Mobile Bankers to your member portfolio
            </p>
          </div>
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-100/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-coastal-primary/20 transition-all"
              value={searchTerm}
        ...
        <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/30 backdrop-blur-sm">
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-900 dark:bg-slate-950 text-white text-left">
                <th className="p-4 font-black text-[10px] tracking-widest uppercase">
                  Member Identity
                </th>
                <th className="p-4 font-black text-[10px] tracking-widest uppercase">
                ...
                <th className="p-4 font-black text-[10px] tracking-widest uppercase text-right">
                  Operational Control
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-750">
              {filteredClients.length === 0 ? (
                <tr>
                  <td
                    colSpan={4}
                    className="p-12 text-center text-slate-400 dark:text-slate-500 font-bold italic"
                  >
                  ...
                  >
                    <td className="p-4">
                      <div className="flex flex-col">
                        <span className="font-black text-slate-900 dark:text-slate-200 leading-tight">
                          {client.name}
                        </span>
                    ...
                    <td className="p-4">
                      {client.assigned_banker ? (
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-950/30 flex items-center justify-center border border-emerald-200 dark:border-emerald-800/30">
                            <ShieldCheck className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                          </div>
                          <div className="flex flex-col">
                            <span className="text-sm font-black text-emerald-900 dark:text-emerald-350">
                              {client.assigned_banker.name}
                            </span>
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/30">
                          ...
                          <span className="text-[10px] font-black text-rose-600 dark:text-rose-450 uppercase tracking-widest">
                            Unassigned
                          </span>
                        </div>
                      )}
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <select
                          ...
                          className="text-xs font-black p-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-coastal-primary/20 outline-none min-w-[150px]"
