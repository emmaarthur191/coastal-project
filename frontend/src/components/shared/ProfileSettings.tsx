...
const ProfileSettings: React.FC<ProfileSettingsProps> = ({ user }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <GlassCard className="p-6 border-l-8 border-l-coastal-primary shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="relative group">
            ...
            <label className="absolute -bottom-3 -right-3 p-3 bg-blue-600 dark:bg-amber-500 text-white dark:text-slate-950 rounded-xl shadow-xl cursor-pointer hover:scale-110 active:scale-95 transition-all z-20 border-2 border-white dark:border-slate-800">
          ...
          <div className="flex-1 text-center md:text-left space-y-1">
            ...
            <p className="text-base text-slate-600 font-medium">
              {user?.username || 'user'} • Professional Profile
            </p>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-900">
                  {profileForm.phone_number || 'Not provided'}
                </p>
              </div>
            </div>
          </div>
      ...
      {message.text && (
        <div
          className={`p-4 rounded-2xl font-bold flex items-center justify-between animate-in zoom-in-95 duration-300 ${
            message.type === 'error'
            ...
            >
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <label
                    htmlFor="first_name"
                    className="text-[10px] font-black text-slate-900 uppercase tracking-widest ml-1"
                  >
                    First Name
                  </label>
                  <input
              ...
              <div className="pt-3">
                <Button
                  type="submit"
                  variant="primary"
                  className="w-full py-4 rounded-2xl text-base font-black shadow-2xl shadow-coastal-primary/20 flex items-center justify-center gap-2 transform active:scale-95 transition-transform"
                  disabled={loading}
                >
                  {loading ? (
                    'Processing...'
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4">
              ...
              <div className="pt-3">
                <Button
                  type="submit"
                  variant="warning"
                  className="w-full py-4 rounded-2xl text-base font-black shadow-2xl shadow-amber-500/20 flex items-center justify-center gap-2 transform active:scale-95 transition-transform"
                  disabled={loading}
                >
                  {loading ? (
                    'Securing...'
        ...
        <div className="lg:col-span-1">
          <GlassCard className="p-6 bg-slate-900 border-none text-white shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div>
                <h4 className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">
              ...
              <div className="flex justify-between items-end border-t border-white/10 pt-3 mt-3">
                <div>
                  ...
                  <p className="text-lg font-mono font-bold text-coastal-primary">
                    {user?.staff_id || 'PRO-9921'}
                  </p>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-[10px] font-bold text-white uppercase bg-white/10 px-2 py-1 rounded">
                    Level 4
                  </p>
                </div>
              </div>
