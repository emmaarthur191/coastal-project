...
export default function MessagingPage() {
  ...
  // Filter users
  const filteredUsers = (Array.isArray(staffUsers) ? staffUsers : []).filter(
    (u) =>
      u.id !== user?.id &&
        ...
        <div className="messaging-sidebar">
          ...
          <div className="messaging-sidebar-header">
            ...
            <div className="messaging-header-icons">
              <div className="messaging-icon-btn" title="Communities">
                <Users size={24} strokeWidth={1.5} />
              </div>
              <div className="messaging-icon-btn" title="Status">
                <div className="messaging-status-icon">
                  <div className="messaging-status-icon-inner"></div>
                </div>
              </div>
              <div
              ...
              <div className="messaging-icon-btn" title="Menu">
          ...
          <div className="messaging-chat-list">
            {loading ? (
              ...
              <div className="messaging-no-chats">
                No chats. Click the icon to start a new chat.
              </div>
            ) : (
              rooms.map((room) => (
                <div
                  ...
                  <div className="messaging-chat-info">
                    ...
                    <div className="messaging-chat-row2">
                      <div className="messaging-chat-preview">
                        {room.last_message ? (
                          <>
                            {user?.id !== room.last_message.sender_id && (
                              <span>{room.last_message.sender_name}: </span>
                            )}
        ...
        {selectedRoom ? (
          <div className="messaging-chat-area">
              ...
              <div className="messaging-chat-header-info">
                <div className="messaging-user-avatar messaging-avatar-margin-right">
                  {selectedRoom.is_group ? (
                    ...
                    selectedRoom.display_name?.[0]?.toUpperCase()
                  )}
                </div>
                <div>
              ...
              {messages.map((msg, i) => {
                ...
                return (
                  <div key={i} className="messaging-message-row">
                    <div
                      className={`messaging-message-bubble ${isOwn ? 'messaging-message-outgoing' : 'messaging-message-incoming'}`}
                    >
                      {/* Sender Name in groups */}
                      {!isOwn && selectedRoom.is_group && (
                        <div className="messaging-message-sender-name">{msg.sender_name}</div>
                      )}
                      {/* Content */}
                      ...
                      <div className="messaging-msg-meta">
                        ...
                        {isOwn && (
                          <span
                            className={
                              msg.is_read ? 'messaging-msg-check-read' : 'messaging-msg-check'
                            }
                          >
            ...
            <div className="messaging-input-area">
              ...
              >
                {newMessage.trim() ? <Send size={26} /> : <Mic size={26} />}
              </div>
            </div>
          </div>
        ) : (
          ...
          <div className="messaging-empty-state">
            <div className="messaging-wrapper-margin-bottom">
              {' '}
            ...
            <div className="messaging-modal-box" onClick={(e) => e.stopPropagation()}>
              <div className="messaging-modal-header">
                <div className="messaging-modal-header-content">
                  <ArrowLeft
                    size={24}
                    className="messaging-modal-back-icon"
              ...
              <div className="messaging-modal-user-list">
                {filteredUsers.map((u) => (
                  <div
                    key={u.id}
                    className="messaging-modal-user-item"
                  ...
                  >
                    ...
                    <div className="messaging-modal-user-info">
                      <div className="messaging-modal-user-name">
