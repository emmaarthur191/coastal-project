...
const UnauthorizedPage = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-red-50 via-white to-gray-50 flex items-center justify-center px-4">
        ...
        <p className="text-gray-600 mb-8">
          ...
          {user && (
            <>
              ...
              <span className="font-semibold text-gray-800">{getRoleDisplayName()}</span>.
            </>
          )}
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-amber-800">
                <strong>Need access?</strong> Contact your administrator or manager to request the
                appropriate permissions for this area.
              </p>
            </div>
          </div>
        </div>
